...
Memory.rooms['E9S8'].strategy_data =[
    ...
    , { role_id : 'a3', role : 'archer', count : 1, body : [ RANGED_ATTACK, RANGED_ATTACK, RANGED_ATTACK, RANGED_ATTACK, RANGED_ATTACK, MOVE]
	, props : { isMilitary:1,  pos_to : { x : 8, y : 6, d : 0} }}
    ...
    , { role : 'builder', count : 7, body : [ WORK, WORK, CARRY, CARRY, CARRY, CARRY, MOVE, MOVE, MOVE, MOVE]
	, props : { is_consumer: 1 } }
